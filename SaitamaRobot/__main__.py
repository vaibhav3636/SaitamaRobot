...
HELP_STRINGS = """
Heyo there! My name is *{}*.
Came here to see the features that I can do?

*Main* commands available[:](https://telegra.ph/file/39a586c950dcf460029e2.jpg)
...
SAITAMA_IMG = "https://telegra.ph/file/aa2625bff5cf7ace4faa6.mp4"
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [[
                        InlineKeyboardButton(
                            text=" Add Hinami to your group",
                            url="t.me/{}?startgroup=true".format(
                                context.bot.username))
                    ]]))
    else:
        update.effective_message.reply_text(
            "hello, who summoned me up! "
            .format(uptime),
